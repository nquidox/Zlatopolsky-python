...
#Задание 1.34
#Не понял как нужно составить программу для решения линейного уравнения.
#Если просто брать два значения случайно, то подобных задач выше было уже много.


#Задание 1.35
print("1.35 Найти гипотенузу треугольника.")
katet135_1 = random.randint(20, 40)
katet135_2 = random.randint(20, 40)
print("Катет 1: {}, катет 2: {}, гипотенуза: {}".format(katet135_1, katet135_2, math.sqrt(math.pow(katet135_1, 2) + math.pow(katet135_2, 2))))
devide()


#Задание 1.36
print("1.36 Найти площадь кольца по внутреннему и внешнему радиусам.")
rad_int_136 = random.randint(10, 20)
rad_ext_136 = random.randint(21, 41)    #внешний радиус принудительно больше во избежание конфузов
print("Внутренний радиус: {}, внешний радиус: {}, площадь кольца: {}".format(rad_int_136, rad_ext_136, (math.pow(rad_ext_136, 2) * math.pi) - (math.pow(rad_int_136, 2) * math.pi)))
devide()


#Задание 1.37
print("1.37 Найти периметр прямоуголного треугольника.")
katet137_1 = random.randint(20, 40)
katet137_2 = random.randint(20, 40)
gipotenuza137 = math.sqrt(math.pow(katet137_2, 2) + math.pow(katet137_2, 2))
perimetr137 = katet137_1 + katet137_2 + gipotenuza137
print("Катет 1: {}, катет 2: {}, гипотенуза: {}, периметр {}".format(katet137_1, katet137_2, gipotenuza137, perimetr137))
devide()


#Задание 1.38
print("1.38 Найти периметр равнобедренной трапеции.")
osnova138_1 = random.randint(1, 11)
osnova138_2 = random.randint(11, 21)    #одно из оснований принудительно больше, чтоб была именно трапеция
height138 = random.randint(1, 6)

#найдем длину катета прямоугольного треугольника образованного боковой стороной и высотой трапеции
triangle_side138 = (osnova138_2 - osnova138_1) / 2

#найдем длинну гипотенузы по теореме Пифагора
gipotenuza138 = math.sqrt(math.pow(triangle_side138, 2) + math.pow(height138, 2))

#а теперь легко посчитаем периметр
perimetr138 = osnova138_1 + osnova138_2 + (gipotenuza138 * 2)
print("Основание 1: {}, основание 2: {}, высота: {}, периметр {}".format(osnova138_1, osnova138_2, height138, perimetr138))


#Задание 1.39 - 42
#Эти задания я пропускаю, так как в них нет ничего нового, кроме нагроможденности дробей всякими мат функциями.
#Подобное уже было, только в более простом виде, тут просто формула будет длиннее в строчку.


#Задание 1.43
#Нахождение средних уже было.


#Задание 1.44
#Нахождение периметра и диагонали(т. Пифагора) уже были.


#Задание 1.45
#Плюс, минус, умножить и поделить 46 заданием? Это такая шутка?


#Задание 1.46
#Уже было для куба, для параллепипеда не сильно сложнее.


#Задание 1.47
#Расстояние на плоскости двух точек можно посчитать как длинну гипотенузы прямоуголного треугольника.
...
#Задание 1.49
#Через угол находится высота трапеции, в остальном все точно так же как в 1.38


#Задание 1.50
#Применить теорему Пифагора для 3 отрезков, подсчет периметра и площади треугольника были.
...
#Задание 1.52 - 56
#Совсем уж простые задачи, особенно после предыдущих.


#Задание 1.57
print("1.57 Перевести из Цельсия в Фаренгейты и Кельвины.")
celcius157 = random.randint(-20, 40)
fahrenheit157 = celcius157 * 1.8 + 32
kelvin157 = celcius157 - 273.15
print("Температура в Цельсиях: {}, Фаренгейтах: {}, Кельвинах: {}".format(celcius157, fahrenheit157, kelvin157))
devide()


#Задание 1.58
print("1.58 450 градусов по Фаренгейту - {}.".format((450 - 32) * 5 / 9))
devide()


#Задание 1.59
print("1.59 Обмен значений двух переменных.")
#Хоть для питона не особо критично, но условно будем считать, что значения одинаковых типов.
var159_a = random.randint(1, 11)
var159_b = random.randint(11, 21)
print("Значения до обмена: {}, {}".format(var159_a, var159_b))

#Поскольку в питоне "переменные" являются именоваными ссылками на объекты,
#то по-питоновски правильно поменять "значения" вот так:
#var159_a, var159_b = var159_b, var159_a

#Но в данном примере сделаем вот так:
var159_a = var159_a + var159_b
var159_b = var159_a - var159_b
var159_a = var159_a - var159_b

print("Значения после обмена: {}, {}".format(var159_a, var159_b))
devide()


#Задание 1.60
print("1.60 Обмен значений 3 переменных, вариант А: b -> c, a -> b, c -> a")
a160 = 1
b160 = 2
c160 = 0

print("Значения до обмена: a: {}, b: {}, c: {}".format(a160, b160, c160))

c160 = b160
b160 = a160
a160 = c160

print("Значения после обмена: a: {}, b: {}, c: {}".format(a160, b160, c160))
devide()


#Задание 1.61
print("1.61 Возведение в степень используя только оператор умножения.")
a161 = 2
print("Значение a во всех примерах для удобства счета примем за {}.".format(a161))
...
a15 = a161 * a161
a_temp15 = a15 * a161
a15 = a_temp15 * a_temp15
a15 *= a15
a15 = a15 * a_temp15

print("а) a^4 за 2 операции: {}".format(a4))
print("а) a^9 за четыре операции: {}".format(a9))
print("а) a^15 за пять операций: {}".format(a15))
devide()


print("Конец заданий первой главы.")
